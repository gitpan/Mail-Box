...
S<< access                              C<'r'> >>
S<< body_delayed_type                   L<Mail::Message::Body::Delayed|Mail::Message::Body::Delayed> >>
S<< body_type                           <folder specific> >>
S<< coerce_options                      C<[]> >>
S<< create                              <false> >>
S<< extract                             C<10240> >>
S<< field_type                          undef >>
...
S<< folder                              C<$ENV{MAIL}> >>
S<< folderdir                           undef >>
S<< head_delayed_type                   L<Mail::Message::Head::Delayed|Mail::Message::Head::Delayed> >>
S<< head_type                           L<Mail::Message::Head::Complete|Mail::Message::Head::Complete> >>
S<< keep_dups                           <false> >>
S<< lock_file                           undef >>
S<< lock_timeout                        1 hour >>
S<< lock_type                           L<Mail::Box::Locker::DotLock|Mail::Box::Locker::DotLock> >>
S<< lock_wait                           10 seconds >>
S<< locker                              undef >>
S<< log                L<Mail::Reporter>  C<'WARNINGS'> >>
S<< manager                             undef >>
S<< message_type                        L<Mail::Box::Message|Mail::Box::Message> >>
S<< multipart_type                      L<Mail::Message::Body::Multipart|Mail::Message::Body::Multipart> >>
S<< remove_when_empty                   <true> >>
S<< save_on_exit                        <true> >>
S<< trace              L<Mail::Reporter>  C<'WARNINGS'> >>
S<< trusted                             <depends on folder location> >>
...
S<< Option       --Defined in     --Default >>
S<< delete_copied                   <false> >>
S<< select                          'ACTIVE' >>
S<< share                           <not used> >>
S<< subfolders                      <folder type dependent> >>
...
S<< Option    --Defined in     --Default >>
S<< check                        <false> >>
S<< folder                       <from calling object> >>
S<< folderdir                    <from folder> >>
S<< skip_empty                   <false> >>
