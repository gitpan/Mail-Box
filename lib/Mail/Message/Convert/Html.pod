...
See L<documentation in base class|Mail::Message::Convert/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Message::Convert/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Message::Convert/"Constructors">.
...
See L<documentation in base class|Mail::Message::Convert/"Converting">.
...
See L<documentation in base class|Mail::Message::Convert/"Error handling">.
...
See L<documentation in base class|Mail::Message::Convert/"Cleanup">.
