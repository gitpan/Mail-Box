...
See L<documentation in base class|Mail::Message/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Message/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Message/"Constructors">.
...
See L<documentation in base class|Mail::Message/"Constructing a message">.
...
See L<documentation in base class|Mail::Message/"The message">.
...
See L<documentation in base class|Mail::Message/"The header">.
...
See L<documentation in base class|Mail::Message/"The body">.
...
See L<documentation in base class|Mail::Message/"Flags">.
...
See L<documentation in base class|Mail::Message/"The whole message as text">.
...
See L<documentation in base class|Mail::Message/"Internals">.
...
See L<documentation in base class|Mail::Message/"Error handling">.
...
See L<documentation in base class|Mail::Message/"Cleanup">.
...
See L<documentation in base class|Mail::Message/"DETAILS">.
