...
S<< body        L<Mail::Message>  <not used> >>
S<< body_type   L<Mail::Message>  L<Mail::Message::Body::Lines|Mail::Message::Body::Lines> >>
S<< deleted     L<Mail::Message>  <false> >>
S<< field_type  L<Mail::Message>  <not used> >>
S<< head        L<Mail::Message>  <not used> >>
S<< head_type   L<Mail::Message>  <not used> >>
S<< labels      L<Mail::Message>  {} >>
S<< log         L<Mail::Reporter>  C<'WARNINGS'> >>
S<< messageId   L<Mail::Message>  <required> >>
S<< modified    L<Mail::Message>  <always false> >>
S<< trace       L<Mail::Reporter>  C<'WARNINGS'> >>
S<< trusted     L<Mail::Message>  <always true> >>
