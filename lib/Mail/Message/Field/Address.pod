...
See L<documentation in base class|Mail::Identity/"DESCRIPTION">.
...
See L<documentation in base class|Mail::Identity/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Identity/"Constructors">.
...
See L<documentation in base class|Mail::Identity/"Attributes">.
...
See L<documentation in base class|Mail::Identity/"Collections">.
