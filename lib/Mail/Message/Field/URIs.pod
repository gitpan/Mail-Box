...
S<< attributes  L<Mail::Message::Field::Structured>  <ignored> >>
S<< charset     L<Mail::Message::Field::Full>  undef >>
S<< datum       L<Mail::Message::Field::Structured>  C<undef> >>
S<< encoding    L<Mail::Message::Field::Full>  C<'q'> >>
S<< force       L<Mail::Message::Field::Full>  false >>
S<< language    L<Mail::Message::Field::Full>  undef >>
