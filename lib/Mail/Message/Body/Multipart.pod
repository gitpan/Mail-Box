...
S<< based_on           L<Mail::Message::Body>  undef >>
S<< boundary                            undef >>
S<< charset            L<Mail::Message::Body>  C<'us-ascii'> >>
S<< checked            L<Mail::Message::Body>  <false> >>
S<< data               L<Mail::Message::Body>  undef >>
S<< description        L<Mail::Message::Body>  undef >>
S<< disposition        L<Mail::Message::Body>  undef >>
S<< eol                L<Mail::Message::Body>  C<'NATIVE'> >>
S<< epilogue                            undef >>
S<< file               L<Mail::Message::Body>  undef >>
S<< log                L<Mail::Reporter>  C<'WARNINGS'> >>
S<< message            L<Mail::Message::Body>  undef >>
S<< mime_type          L<Mail::Message::Body>  C<'multipart/mixed'> >>
S<< modified           L<Mail::Message::Body>  <false> >>
S<< parts                               undef >>
S<< preamble                            undef >>
S<< trace              L<Mail::Reporter>  C<'WARNINGS'> >>
S<< transfer_encoding  L<Mail::Message::Body>  C<'none'> >>
...
S<< Option     --Defined in     --Default >>
S<< max_lines    L<Mail::Message::Body::Construct>  C<10> >>
S<< pattern      L<Mail::Message::Body::Construct>  C<qr/^--\s?$/> >>
S<< result_type  L<Mail::Message::Body::Construct>  <same as current> >>
...
I<Error:> You cannot use foreachLine on a multipart
