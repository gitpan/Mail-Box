...
S<< Cc                             undef >>
S<< Date                           <now> >>
S<< Delivered-To                   undef >>
S<< From                           <required> >>
S<< Message-ID                     <uniquely created> >>
S<< Received                       <created> >>
S<< Return-Path                    undef >>
S<< Sender                         undef >>
S<< To                             undef >>
S<< head                           <created automatically> >>
S<< log           L<Mail::Reporter>  C<'WARNINGS'> >>
S<< message_head                   C<undef> >>
S<< software      L<Mail::Message::Head::FieldGroup>  C<undef> >>
S<< trace         L<Mail::Reporter>  C<'WARNINGS'> >>
S<< type          L<Mail::Message::Head::FieldGroup>  C<undef> >>
S<< version       L<Mail::Message::Head::FieldGroup>  C<undef> >>
