...
See L<documentation in base class|Mail::Message::Head::FieldGroup/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Message::Head::FieldGroup/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Message::Head::FieldGroup/"Constructors">.
...
See L<documentation in base class|Mail::Message::Head::FieldGroup/"The header">.
...
See L<documentation in base class|Mail::Message::Head::FieldGroup/"Access to the header">.
...
See L<documentation in base class|Mail::Message::Head::FieldGroup/"Internals">.
...
See L<documentation in base class|Mail::Message::Head::FieldGroup/"Error handling">.
...
See L<documentation in base class|Mail::Message::Head::FieldGroup/"Cleanup">.
