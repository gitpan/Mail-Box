...
See L<documentation in base class|Mail::Message::Head::Complete/"DESCRIPTION">.
 
=head1 OVERLOADED

See L<documentation in base class|Mail::Message::Head::Complete/"OVERLOADED">.
...
See L<documentation in base class|Mail::Message::Head::Complete/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Message::Head::Complete/"Constructors">.
...
See L<documentation in base class|Mail::Message::Head::Complete/"The header">.
...
See L<documentation in base class|Mail::Message::Head::Complete/"Access to the header">.
...
See L<documentation in base class|Mail::Message::Head::Complete/"About the body">.
...
See L<documentation in base class|Mail::Message::Head::Complete/"Internals">.
...
See L<documentation in base class|Mail::Message::Head::Complete/"Error handling">.
...
See L<documentation in base class|Mail::Message::Head::Complete/"Cleanup">.
...
See L<documentation in base class|Mail::Message::Head::Complete/"DETAILS">.
 
=head2 Ordered header fields

See L<documentation in base class|Mail::Message::Head::Complete/"Ordered header fields">.
 
=head2 Head class implementation

See L<documentation in base class|Mail::Message::Head::Complete/"Head class implementation">.
 
=head2 Subsets of header fields

See L<documentation in base class|Mail::Message::Head::Complete/"Subsets of header fields">.
