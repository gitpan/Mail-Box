...
S<< MailFrom                     C<'KEEP'> >>
S<< Modify                       0 >>
S<< body        L<Mail::Message>  undef >>
S<< body_type   L<Mail::Message>  L<Mail::Message::Body::Lines|Mail::Message::Body::Lines> >>
S<< deleted     L<Mail::Message>  <false> >>
S<< field_type  L<Mail::Message>  undef >>
S<< head        L<Mail::Message>  undef >>
S<< head_type   L<Mail::Message>  L<Mail::Message::Replace::MailHeader|Mail::Message::Replace::MailHeader> >>
S<< labels      L<Mail::Message>  {} >>
S<< log         L<Mail::Reporter>  C<'WARNINGS'> >>
S<< messageId   L<Mail::Message>  undef >>
S<< modified    L<Mail::Message>  <false> >>
S<< trace       L<Mail::Reporter>  C<'WARNINGS'> >>
S<< trusted     L<Mail::Message>  <false> >>
...
S<< Option             --Defined in     --Default >>
S<< body_type            L<Mail::Message::Construct::Read>  C<undef> >>
S<< strip_status_fields  L<Mail::Message::Construct::Read>  <true> >>
...
S<< Option         --Defined in     --Default >>
S<< Bcc              L<Mail::Message::Construct::Reply>  undef >>
S<< Cc               L<Mail::Message::Construct::Reply>  <'cc' in current> >>
S<< Exclude                           [] >>
S<< From             L<Mail::Message::Construct::Reply>  <'to' in current> >>
S<< Inline                            E<gt> >>
S<< Keep                              [] >>
S<< Message-ID       L<Mail::Message::Construct::Reply>  <uniquely generated> >>
S<< ReplyAll                          <false> >>
S<< Subject          L<Mail::Message::Construct::Reply>  L<replySubject()|Mail::Message::Construct::Reply/"Constructing a message"> >>
S<< To               L<Mail::Message::Construct::Reply>  <sender in current> >>
S<< body             L<Mail::Message::Construct::Reply>  undef >>
S<< group_reply      L<Mail::Message::Construct::Reply>  <true> >>
S<< header_template                   C<$ENV{HOME}/.mailhdr> >>
S<< include          L<Mail::Message::Construct::Reply>  C<'INLINE'> >>
S<< max_signature    L<Mail::Message::Construct::Reply>  C<10> >>
S<< message_type     L<Mail::Message::Construct::Reply>  L<Mail::Message|Mail::Message> >>
S<< postlude         L<Mail::Message::Construct::Reply>  undef >>
S<< prelude          L<Mail::Message::Construct::Reply>  undef >>
S<< quote            L<Mail::Message::Construct::Reply>  'E<gt> ' >>
S<< signature        L<Mail::Message::Construct::Reply>  undef >>
S<< strip_signature  L<Mail::Message::Construct::Reply>  C<qr/^--\s/> >>
...
S<< Option  --Defined in     --Default >>
S<< Debug                      <false> >>
S<< Hello                      <helo_domain from Net::Config> >>
S<< Host                       C<$ENV{SMTPHOSTS} or from Net::Config> >>
S<< MailFrom                   C<$ENV{MAILADDRESS}> or $ENV{USER} >>
S<< Port                       25 >>
