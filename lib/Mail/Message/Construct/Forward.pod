...
S<< Cc                           undef >>
S<< Date                         <now> >>
S<< From                         <'to' in current> >>
S<< Message-ID                   <uniquely generated> >>
S<< Subject                      L<forwardSubject()|Mail::Message::Construct::Forward/"Constructing a message"> >>
S<< To                           <required> >>
S<< body                         undef >>
S<< include                      <if body then C<'NO'> else C<'INLINE'>> >>
S<< preamble                     C<constructed from prelude and postlude> >>
S<< signature                    undef >>
...
S<< Option         --Defined in     --Default >>
S<< is_attached                       C<"[The forwarded message is attached]\n"> >>
S<< max_signature                     C<10> >>
S<< postlude                          undef >>
S<< prelude                           undef >>
S<< quote                             undef >>
S<< strip_signature                   C<qr/^--\s/> >>
