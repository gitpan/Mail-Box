...
See L<documentation in base class|Mail::Message::TransferEnc/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Message::TransferEnc/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Message::TransferEnc/"Constructors">.
...
See L<documentation in base class|Mail::Message::TransferEnc/"The Encoder">.
...
See L<documentation in base class|Mail::Message::TransferEnc/"Encoding">.
...
See L<documentation in base class|Mail::Message::TransferEnc/"Error handling">.
...
See L<documentation in base class|Mail::Message::TransferEnc/"Cleanup">.
