...
See L<documentation in base class|Mail::Box::Dir::Message/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Box::Dir::Message/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Box::Dir::Message/"Constructors">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"Constructing a message">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"The message">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"The header">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"The body">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"Flags">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"The whole message as text">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"Internals">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"Error handling">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"Cleanup">.
...
See L<documentation in base class|Mail::Box::Dir::Message/"DETAILS">.
 
=head2 Structure of a Message

See L<documentation in base class|Mail::Box::Dir::Message/"Structure of a Message">.
 
=head2 Message object implementation

See L<documentation in base class|Mail::Box::Dir::Message/"Message object implementation">.
 
=head2 Message class implementation

See L<documentation in base class|Mail::Box::Dir::Message/"Message class implementation">.
 
=head2 Labels

See L<documentation in base class|Mail::Box::Dir::Message/"Labels">.
 
=head3 Predefined labels

See L<documentation in base class|Mail::Box::Dir::Message/"Predefined labels">.
 
=head3 Status and X-Status fields

See L<documentation in base class|Mail::Box::Dir::Message/"Status and X-Status fields">.
