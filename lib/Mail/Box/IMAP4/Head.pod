...
S<< cache_fields                   C<false> >>
S<< field_type    L<Mail::Message::Head>  L<Mail::Message::Field::Fast|Mail::Message::Field::Fast> >>
S<< log           L<Mail::Reporter>  C<'WARNINGS'> >>
S<< message       L<Mail::Message::Head>  undef >>
S<< modified      L<Mail::Message::Head>  <false> >>
