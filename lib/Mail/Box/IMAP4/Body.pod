...
Mail::Box::IMAP4::Body-E<gt>B<new>(OPTIONS)
...
Mail::Box::IMAP4::Body-E<gt>B<addTransferEncHandler>(NAME, CLASS|OBJECT)
...
Mail::Box::IMAP4::Body-E<gt>B<defaultTrace>([LEVEL, [LEVEL])
...
Mail::Box::IMAP4::Body-E<gt>B<log>([LEVEL [,STRINGS]])
...
Mail::Box::IMAP4::Body-E<gt>B<logPriority>(LEVEL)
