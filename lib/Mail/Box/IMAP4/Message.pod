...
See L<documentation in base class|Mail::Box::Net::Message/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Box::Net::Message/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Box::Net::Message/"Constructors">.
...
See L<documentation in base class|Mail::Box::Net::Message/"Constructing a message">.
...
See L<documentation in base class|Mail::Box::Net::Message/"The message">.
...
See L<documentation in base class|Mail::Box::Net::Message/"The header">.
...
See L<documentation in base class|Mail::Box::Net::Message/"The body">.
...
See L<documentation in base class|Mail::Box::Net::Message/"Flags">.
...
See L<documentation in base class|Mail::Box::Net::Message/"The whole message as text">.
...
See L<documentation in base class|Mail::Box::Net::Message/"Internals">.
...
See L<documentation in base class|Mail::Box::Net::Message/"Error handling">.
...
See L<documentation in base class|Mail::Box::Net::Message/"Cleanup">.
...
See L<documentation in base class|Mail::Box::Net::Message/"DETAILS">.
 
=head2 Structure of a Message

See L<documentation in base class|Mail::Box::Net::Message/"Structure of a Message">.
 
=head2 Message object implementation

See L<documentation in base class|Mail::Box::Net::Message/"Message object implementation">.
 
=head2 Message class implementation

See L<documentation in base class|Mail::Box::Net::Message/"Message class implementation">.
 
=head2 Labels

See L<documentation in base class|Mail::Box::Net::Message/"Labels">.
 
=head3 Predefined labels

See L<documentation in base class|Mail::Box::Net::Message/"Predefined labels">.
 
=head3 Status and X-Status fields

See L<documentation in base class|Mail::Box::Net::Message/"Status and X-Status fields">.
