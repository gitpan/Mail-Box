...
Mail::Box::IMAP4::DelayedHead - message header is remote


=head1 INHERITANCE

 Mail::Box::IMAP4::DelayedHead realizes a Mail::Message::Head::Complete

 Mail::Box::IMAP4::DelayedHead
...
This object is used as place-holder for unreceived header data, to be replaced
by a L<Mail::Message::Head|Mail::Message::Head> when someone accesses the header of a message for
functionality which is not provided by the IMAP4 protocol.
...
See L<Mail::Message::Head::Delayed/"Constructors">

=back

Mail::Box::IMAP4::DelayedHead-E<gt>B<new>(OPTIONS)
...
Mail::Box::IMAP4::DelayedHead-E<gt>B<defaultTrace>([LEVEL, [LEVEL])
...
Mail::Box::IMAP4::DelayedHead-E<gt>B<log>([LEVEL [,STRINGS]])
...
Mail::Box::IMAP4::DelayedHead-E<gt>B<logPriority>(LEVEL)
