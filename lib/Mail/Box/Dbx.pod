...
S<< access             L<Mail::Box>     always C<'r'> >>
...
S<< create             L<Mail::Box>     C<not implemented> >>
S<< extract            L<Mail::Box>     C<10240> >>
S<< field_type         L<Mail::Box>     undef >>
S<< fix_headers        L<Mail::Box>     <false> >>
S<< folder             L<Mail::Box>     C<=Folders.dbx> >>
S<< folderdir          L<Mail::Box>     C<.> >>
...
S<< message_type       L<Mail::Box>     L<Mail::Box::Dbx::Message|Mail::Box::Dbx::Message> >>
S<< multipart_type     L<Mail::Box>     L<Mail::Message::Body::Multipart|Mail::Message::Body::Multipart> >>
S<< remove_when_empty  L<Mail::Box>     C<not implemented> >>
S<< save_on_exit       L<Mail::Box>     C<not implemented> >>
S<< trace              L<Mail::Reporter>  C<'WARNINGS'> >>
S<< trusted            L<Mail::Box>     <depends on folder location> >>
S<< write_policy       L<Mail::Box::File>  C<not implemented> >>
