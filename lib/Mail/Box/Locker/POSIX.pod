...
See L<documentation in base class|Mail::Box::Locker/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Box::Locker/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Box::Locker/"Constructors">.
...
See L<documentation in base class|Mail::Box::Locker/"The Locker">.
...
See L<documentation in base class|Mail::Box::Locker/"Locking">.
...
See L<documentation in base class|Mail::Box::Locker/"Error handling">.
...
See L<documentation in base class|Mail::Box::Locker/"Cleanup">.
