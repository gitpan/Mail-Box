...
S<< autodetect                            C<undef> >>
S<< default_folder_type                   C<'mbox'> >>
S<< folder_types                          <all standard types> >>
S<< folderdir                             C<[ '.' ]> >>
S<< folderdirs                            <synonym for C<folderdir>> >>
