...
S<< message_type       L<Mail::Box>     L<Mail::Box::POP3::Message|Mail::Box::POP3::Message> >>
...
S<< server_port        L<Mail::Box::Net>  110 >>
...
S<< Option   --Defined in  --Default >>
S<< recursive  L<Mail::Box>  <not used> >>
