...
See L<documentation in base class|Mail::Box::Net/"DESCRIPTION">.
 
=head1 OVERLOADED

See L<documentation in base class|Mail::Box::Net/"OVERLOADED">.
...
See L<documentation in base class|Mail::Box::Net/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Box::Net/"Constructors">.
...
See L<documentation in base class|Mail::Box::Net/"The folder">.
...
See L<documentation in base class|Mail::Box::Net/"Folder flags">.
...
See L<documentation in base class|Mail::Box::Net/"The messages">.
...
See L<documentation in base class|Mail::Box::Net/"Sub-folders">.
...
See L<documentation in base class|Mail::Box::Net/"Internals">.
...
See L<documentation in base class|Mail::Box::Net/"Other methods">.
...
See L<documentation in base class|Mail::Box::Net/"Error handling">.
...
See L<documentation in base class|Mail::Box::Net/"Cleanup">.
...
See L<documentation in base class|Mail::Box::Net/"DETAILS">.
 
=head2 Different kinds of folders

See L<documentation in base class|Mail::Box::Net/"Different kinds of folders">.
 
=head2 Available folder types

See L<documentation in base class|Mail::Box::Net/"Available folder types">.
 
=head2 Folder class implementation

See L<documentation in base class|Mail::Box::Net/"Folder class implementation">.
