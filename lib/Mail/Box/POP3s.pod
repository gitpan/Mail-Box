...
Mail::Box::POP3s-E<gt>B<new>(OPTIONS)
...
Mail::Box::POP3s-E<gt>B<appendMessages>(OPTIONS)
...
Mail::Box::POP3s-E<gt>B<foundIn>([FOLDERNAME], OPTIONS)
...
This module is part of Mail-Box distribution version 2.096,
built on November 09, 2010. Website: F<http://perl.overmeer.net/mailbox/>
