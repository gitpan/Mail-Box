...
See L<documentation in base class|Mail::Box::POP3/"DESCRIPTION">.
 
=head1 OVERLOADED

See L<documentation in base class|Mail::Box::POP3/"OVERLOADED">.
...
See L<documentation in base class|Mail::Box::POP3/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Box::POP3/"Constructors">.
...
See L<documentation in base class|Mail::Box::POP3/"The folder">.
...
See L<documentation in base class|Mail::Box::POP3/"Folder flags">.
...
See L<documentation in base class|Mail::Box::POP3/"The messages">.
...
See L<documentation in base class|Mail::Box::POP3/"Sub-folders">.
...
See L<documentation in base class|Mail::Box::POP3/"Internals">.
...
See L<documentation in base class|Mail::Box::POP3/"Other methods">.
...
See L<documentation in base class|Mail::Box::POP3/"Error handling">.
...
See L<documentation in base class|Mail::Box::POP3/"Cleanup">.
...
See L<documentation in base class|Mail::Box::POP3/"DETAILS">.
