...
S<< index                               undef >>
S<< index_filename                      <foldername>C</.index> >>
S<< index_type                          L<Mail::Box::MH::Index|Mail::Box::MH::Index> >>
S<< keep_dups          L<Mail::Box>     <false> >>
S<< keep_index                          0 >>
S<< labels                              undef >>
S<< labels_filename                     <foldername>C</.mh_sequence> >>
S<< labels_type                         L<Mail::Box::MH::Labels|Mail::Box::MH::Labels> >>
S<< lock_file          L<Mail::Box>     <index_file> >>
...
S<< message_type       L<Mail::Box>     L<Mail::Box::Message|Mail::Box::Message> >>
...
S<< Option  --Defined in     --Default >>
S<< folder    L<Mail::Box>     <required> >>
S<< message   L<Mail::Box>     undef >>
S<< messages  L<Mail::Box>     undef >>
S<< share     L<Mail::Box>     <false> >>
