...
S<< autodetect           L<Mail::Box::Manager>  C<undef> >>
S<< collection_type                       L<Mail::Box::Collection|Mail::Box::Collection> >>
S<< default_folder_type  L<Mail::Box::Manager>  C<'mbox'> >>
S<< delimiter                             "/" >>
S<< folder_id_type                        L<Mail::Box::Identity|Mail::Box::Identity> >>
S<< folder_types         L<Mail::Box::Manager>  <all standard types> >>
S<< folderdir            L<Mail::Box::Manager>  C<[ '.' ]> >>
S<< folderdirs           L<Mail::Box::Manager>  <synonym for C<folderdir>> >>
S<< identity                              <required> >>
S<< inbox                                 C<undef> >>
...
S<< Option   --Defined in           --Default >>
S<< recursive  L<Mail::Box::Manager>  <folder's default> >>
