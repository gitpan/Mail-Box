...
See L<documentation in base class|User::Identity::Item/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Reporter/"METHODS">.
 
See L<documentation in base class|User::Identity::Item/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Reporter/"Constructors">.
 
See L<documentation in base class|User::Identity::Item/"Constructors">.
...
See L<documentation in base class|User::Identity::Item/"Attributes">.
...
See L<documentation in base class|User::Identity::Item/"Collections">.
