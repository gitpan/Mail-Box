...
See L<documentation in base class|Mail::Reporter/"DESCRIPTION">.
 
See L<documentation in base class|User::Identity::Collection/"DESCRIPTION">.
 
=head1 OVERLOADED

See L<documentation in base class|User::Identity::Collection/"OVERLOADED">.
...
See L<documentation in base class|Mail::Reporter/"METHODS">.
 
See L<documentation in base class|User::Identity::Collection/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Reporter/"Constructors">.
 
See L<documentation in base class|User::Identity::Collection/"Constructors">.
...
See L<documentation in base class|Mail::Reporter/"Error handling">.
...
See L<documentation in base class|Mail::Reporter/"Cleanup">.
...
See L<documentation in base class|User::Identity::Collection/"Attributes">.
...
See L<documentation in base class|User::Identity::Collection/"Collections">.
...
See L<documentation in base class|User::Identity::Collection/"Maintaining roles">.
...
See L<documentation in base class|User::Identity::Collection/"Searching">.
