...
S<< description  L<User::Identity::Item>  undef >>
S<< folder_type                   <from parent> >>
S<< item_type    L<User::Identity::Collection>  L<Mail::Box::Identity|Mail::Box::Identity> >>
S<< log          L<Mail::Reporter>  C<'WARNINGS'> >>
S<< manager                       <from parent> >>
S<< name         L<User::Identity::Item>  C<'folders'> >>
S<< parent       L<User::Identity::Item>  C<undef> >>
S<< roles        L<User::Identity::Collection>  undef >>
