...
S<< account_name                   <from dbx_record> >>
S<< account_nr                     <from dbx_record> >>
S<< body          L<Mail::Message>  undef >>
S<< body_type     L<Mail::Box::Message>  <from folder> >>
S<< dbx_record                     <required> >>
S<< deleted       L<Mail::Message>  <false> >>
S<< field_type    L<Mail::Message>  undef >>
S<< folder        L<Mail::Box::Message>  <required> >>
S<< from_line     L<Mail::Box::File::Message>  undef >>
S<< head          L<Mail::Message>  undef >>
S<< head_type     L<Mail::Message>  L<Mail::Message::Head::Complete|Mail::Message::Head::Complete> >>
S<< labels        L<Mail::Message>  {} >>
S<< log           L<Mail::Reporter>  C<'WARNINGS'> >>
S<< messageId     L<Mail::Message>  undef >>
S<< modified      L<Mail::Message>  <false> >>
S<< seen                           <from dbx_record> >>
S<< size          L<Mail::Box::Message>  undef >>
