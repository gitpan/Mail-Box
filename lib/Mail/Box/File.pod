...
S<< message_type       L<Mail::Box>     L<Mail::Box::File::Message|Mail::Box::File::Message> >>
...
S<< policy                         undef >>
S<< save_deleted  L<Mail::Box>     <false> >>
