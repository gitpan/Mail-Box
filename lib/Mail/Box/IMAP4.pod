...
S<< access             L<Mail::Box>     'r' >>
S<< body_delayed_type  L<Mail::Box>     L<Mail::Message::Body::Delayed|Mail::Message::Body::Delayed> >>
S<< body_type          L<Mail::Box>     L<Mail::Message::Body::Lines|Mail::Message::Body::Lines> >>
S<< cache_body                          C<NO> >>
S<< cache_head                          C<NO> or C<DELAY> >>
S<< cache_labels                        C<NO> or C<DELAY> >>
...
S<< folder             L<Mail::Box>     C</> >>
S<< folderdir          L<Mail::Box>     <not used> >>
S<< head_delayed_type  L<Mail::Box>     L<Mail::Message::Head::Delayed|Mail::Message::Head::Delayed> >>
S<< head_type          L<Mail::Box>     L<Mail::Box::IMAP4::Head|Mail::Box::IMAP4::Head> or L<Mail::Message::Head::Complete|Mail::Message::Head::Complete> >>
S<< join_connection                     C<true> >>
S<< keep_dups          L<Mail::Box>     <false> >>
S<< lock_file          L<Mail::Box>     undef >>
S<< lock_timeout       L<Mail::Box>     1 hour >>
S<< lock_type          L<Mail::Box>     C<'NONE'> >>
S<< lock_wait          L<Mail::Box>     10 seconds >>
S<< locker             L<Mail::Box>     undef >>
S<< log                L<Mail::Reporter>  C<'WARNINGS'> >>
S<< manager            L<Mail::Box>     undef >>
S<< message_type       L<Mail::Box>     L<Mail::Box::IMAP4::Message|Mail::Box::IMAP4::Message> >>
S<< multipart_type     L<Mail::Box>     L<Mail::Message::Body::Multipart|Mail::Message::Body::Multipart> >>
S<< password           L<Mail::Box::Net>  undef >>
S<< remove_when_empty  L<Mail::Box>     <false> >>
S<< save_on_exit       L<Mail::Box>     <true> >>
S<< server_name        L<Mail::Box::Net>  undef >>
S<< server_port        L<Mail::Box::Net>  143 >>
S<< trace              L<Mail::Reporter>  C<'WARNINGS'> >>
S<< transporter                         L<Mail::Transport::IMAP4|Mail::Transport::IMAP4> >>
S<< trusted            L<Mail::Box>     <false> >>
S<< username           L<Mail::Box::Net>  undef >>
...
S<< Option      --Defined in     --Default >>
S<< force         L<Mail::Box>     <false> >>
S<< save_deleted  L<Mail::Box>     C<false> >>
S<< write         L<Mail::Box>     C<MODIFIED> >>
...
S<< Option     --Defined in     --Default >>
S<< messages     L<Mail::Box>     <required> >>
S<< transporter                   <required> >>
