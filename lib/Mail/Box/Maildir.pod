...
S<< folderdir          L<Mail::Box>     C<$ENV{HOME}/.maildir> >>
...
S<< lock_file          L<Mail::Box>     <not used> >>
S<< lock_timeout       L<Mail::Box>     <not used> >>
S<< lock_type          L<Mail::Box>     C<'NONE'> (constant) >>
S<< lock_wait          L<Mail::Box>     <not used> >>
