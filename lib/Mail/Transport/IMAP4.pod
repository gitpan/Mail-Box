...
$obj-E<gt>B<flagsToLabels>(FLAGS)

Mail::Transport::IMAP4-E<gt>B<flagsToLabels>(FLAGS)
...
value may either by set or cleared.  See L<getFlags()|Mail::Transport::IMAP4/"Protocol [internals]">
