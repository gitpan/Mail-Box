...
See L<documentation in base class|Mail::Transport/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Transport/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|Mail::Transport/"Constructors">.
...
See L<documentation in base class|Mail::Transport/"Server connection">.
...
See L<documentation in base class|Mail::Transport/"Error handling">.
...
See L<documentation in base class|Mail::Transport/"Cleanup">.
