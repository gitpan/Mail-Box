...
S<< executable  L<Mail::Transport>  C<undef> >>
S<< hostname    L<Mail::Transport>  C<'localhost'> >>
S<< interval    L<Mail::Transport>  C<30> >>
S<< log         L<Mail::Reporter>  C<'WARNINGS'> >>
S<< password    L<Mail::Transport>  undef >>
S<< port        L<Mail::Transport>  undef >>
S<< proxy       L<Mail::Transport>  undef >>
S<< retry       L<Mail::Transport>  <false> >>
S<< timeout     L<Mail::Transport>  C<120> >>
S<< trace       L<Mail::Reporter>  C<'WARNINGS'> >>
S<< username    L<Mail::Transport>  undef >>
S<< via         L<Mail::Transport>  C<'sendmail'> >>
...
S<< Option  --Defined in     --Default >>
S<< interval                   L<new(interval)|Mail::Transport/"METHODS"> >>
S<< retry                      L<new(retry)|Mail::Transport/"METHODS"> >>
S<< to                         C<undef> >>
