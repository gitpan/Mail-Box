...
S<< helo                         <from Net::Config> >>
S<< hostname    L<Mail::Transport>  <from Net::Config> >>
S<< interval    L<Mail::Transport>  C<30> >>
S<< log         L<Mail::Reporter>  C<'WARNINGS'> >>
S<< password                     undef >>
S<< port        L<Mail::Transport>  C<25> >>
S<< proxy       L<Mail::Transport>  <from Net::Config> >>
S<< retry       L<Mail::Transport>  <false> >>
S<< smtp_debug                   <false> >>
S<< timeout                      120 >>
S<< trace       L<Mail::Reporter>  C<'WARNINGS'> >>
S<< username                     undef >>
S<< via         L<Mail::Transport>  C<'smtp'> >>
