...
See L<documentation in base class|Mail::Server/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|Mail::Server/"METHODS">.
...
See L<documentation in base class|Mail::Server/"DETAILS">.
