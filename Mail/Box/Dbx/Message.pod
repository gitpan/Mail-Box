...
A flag (see L<label()|"Flags">) which tells wether this message has been read
...
this message, represented as a string.  The L<accountNr()|"The flags"> returns
...
Returns the Outlook Express account name which was used to retreive
this message, represented as a number.  The L<accountName()|"The flags"> returns
