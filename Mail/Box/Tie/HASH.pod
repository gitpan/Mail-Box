...
L<FIRSTKEY()|"Tied Interface"> returns the first message-id/message pair from the folder,
...
L<Mail::Box::messages()|"The messages"> method of the folder type for more information
