...
=item B<from_line> =E<gt> STRING

See Mail::Box::File::Message::new(from_line)
...
See Mail::Box::File::Message::write()
...
See Mail::Box::Message::isDeleted()
...
See Mail::Box::File::Message::fileLocation()

=item B<fromLine> [LINE]

See Mail::Box::File::Message::fromLine()
...
See Mail::Box::File::Message::loadBody()

=item B<moveLocation> DISTANCE

See Mail::Box::File::Message::moveLocation()

=item B<read> PARSER

See Mail::Box::File::Message::read()
