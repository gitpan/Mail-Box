...
=item B<expand> [BOOLEAN] X<expand>
...
=item B<follows> THREAD, QUALITY X<follows>
...
=item B<sortedFollowUps> [PREPARE [,COMPARE]] X<sortedFollowUps>
...
=item B<endTimeEstimate>  X<endTimeEstimate>
...
=item B<startTimeEstimate>  X<startTimeEstimate>
...
=item B<threadMessages>  X<threadMessages>
...
=item B<threadToString> [CODE] X<threadToString>
