...
Print the information about the match (see L<new(deliver)|"METHODS">) in
...
Th search object does not implement L<inBody()|"Searching">, and can therefore
not search a message body.

I<Error:> Cannot search in header.

Th search object does not implement L<inHead()|"Searching">, and can therefore
