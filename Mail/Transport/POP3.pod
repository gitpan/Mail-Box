...
Mark all messages that have been fetched with L<message()|"Exchanging information"> for deletion.
See L<fetched()|"Exchanging information">.
...
L<message()|"Exchanging information">.  This can be used to update a database of messages that
...
See also L<deleteFetched()|"Exchanging information">.
