...
folder.  The folder types are:
 ...
 L<Mail::Box::Mbox|Mail::Box::Mbox>    L<Mail::Box::Maildir|Mail::Box::Maildir>  L<Mail::Box::POP3|Mail::Box::POP3>
 |  L<Mail::Box::Dbx|Mail::Box::Dbx>  |  L<Mail::Box::MH|Mail::Box::MH>    |  L<Mail::Box::IMAP4|Mail::Box::IMAP4>
 |  |               |  |                |  |
 |  |               |  |                |  |
 L<Mail::Box::File|Mail::Box::File>    L<Mail::Box::Dir|Mail::Box::Dir>      L<Mail::Box::Net|Mail::Box::Net>
       |                  |                   |
       `--------------.   |   .---------------'
                      |   |   |
                      L<Mail::Box|Mail::Box>
