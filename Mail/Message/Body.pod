...
For example:
 ...
 my $body    = L<Mail::Message::Body::String|Mail::Message::Body::String>->new(mime_type => 'image/gif');
...
but this call will be most efficient for the L<Mail::Message::Body::Lines|Mail::Message::Body::Lines>
type.
...
the body are returned.  This is the same as using L<lines()|"Access to the payload">.
...
message. Use L<Mail::Message::clone()|"Constructors"> for a whole message.
...
got, and then call L<encode()|"Constructing a body"> for what you need.
...
will have to call L<encode()|"Constructing a body"> after the body is created.  That will
...
The C<$dec> which is returned is a body.  Ask with the L<mimeType()|"About the payload"> method
...
want to call L<Mail::Message::decoded()|"The body"> first.
...
needs to be changed, call the L<encode()|"Constructing a body"> or L<decoded()|"Constructing a body"> method.
...
The returned is a reference to a L<Mail::Message::Field|Mail::Message::Field> object, where
you can ask for the C<body> (main content of the field) and the comment
(after a semicolon).  To get to the body, you can better use L<mimeType()|"About the payload">.
...
To just get the number of lines in the body, use the L<nrLines()|"About the payload"> method,
