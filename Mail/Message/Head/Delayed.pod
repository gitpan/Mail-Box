...
L<Mail::Message::size()|"The Message"> usually will give a figure for the whole message
...
For messages in directory or network organized folders,
L<Mail::Message::timestamp()|"The header"> usually will give a figure without much cost.
