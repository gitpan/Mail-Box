...
a leading C<gt>.  See L<Mail::Message::Body::printEscapedFrom()|"Access to the payload">.
...
Bodies are coerced into message parts by calling L<buildFromBody()|"METHODS">.
...
Do not print or send this part of the message anymore.  See L<deleted()|"Flags">.
...
argument, the method returns the same is the L<isDeleted()|"Flags"> method, which is
prefered.  When a true value is given, L<delete()|"Flags"> is called.
