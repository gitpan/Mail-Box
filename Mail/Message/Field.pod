...
See L<Mail::Message::Field::Fast::new()|Mail::Message::Field::Fast/"METHODS">, L<Mail::Message::Field::Flex::new()|Mail::Message::Field::Flex/"METHODS">,
...
L<unfoldedBody()|Mail::Message::Field/"Access to the body"> is being stripped and returned.
...
This method is called by L<new()|Mail::Message::Field/"Constructors">, and usually not be an application
program.
