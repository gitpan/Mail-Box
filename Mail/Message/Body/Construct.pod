...
L<Mail::Message::coerce()|"Constructors">.  A new body with attached messages is
returned.

I<Example:> 

 my $pgpkey = L<Mail::Message::Body::File|Mail::Message::Body::File>->new(file => '.pgp');
 my $msg    = L<Mail::Message|Mail::Message>->buildFromBody(
...
I<Example:> 
 ...
 # all arguments are L<Mail::Message::Body|Mail::Message::Body>'s.
