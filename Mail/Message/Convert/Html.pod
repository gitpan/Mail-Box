...
=item B<head_mailto> =E<gt> BOOLEAN
...
=item B<produce> =E<gt> 'HTML'|'XHTML'
...
=item B<fieldContentsToHtml> FIELD, [SUBJECT]
...
=item B<fieldToHtml> FIELD, [SUBJECT]
...
=item B<headToHtmlHead> HEAD, META
...
=item B<headToHtmlTable> HEAD, [TABLE-PARAMS]
