...
=item B<addComponent> STRING X<addComponent>
...
=item B<new> (NAME, [VALUE] | STRING), OPTIONS X<new>
...
=item B<use_continuations> =E<gt> BOOLEAN X<new(use_continuations)>
