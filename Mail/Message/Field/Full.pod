...
Creates a comment (see L<createComment()|Mail::Message::Field::Full/"Access to the content">) and adds it immediately to
...
Create a phrase (see L<createPhrase()|Mail::Message::Field::Full/"Access to the content">) and immediately add it to this field.
...
See L<addComment()|Mail::Message::Field::Full/"Access to the content">.  The created comment is returned.
