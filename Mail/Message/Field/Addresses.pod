...
Mail::Message::Field::Addresses-E<gt>B<new>(DATA)

=over 4

 Option         Defined in       Default       
 attributes     L<Mail::Message::Field::Full>  <not accepted>
 charset        L<Mail::Message::Field::Full>  undef         
 encoding       L<Mail::Message::Field::Full>  C<'q'>        
 extra          L<Mail::Message::Field::Full>  <not accepted>
 force          L<Mail::Message::Field::Full>  false         
 is_structured  L<Mail::Message::Field::Full>  <true>        
...
L<Mail::Message::Field::Address::new()|Mail::Message::Field::Address/"METHODS">.
...
$obj-E<gt>B<consumeAddress>(STRING)
...
I<Warning:> Illegal part in address field $name: $string
