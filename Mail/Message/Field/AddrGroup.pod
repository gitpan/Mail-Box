...
Mail::Message::Field::AddrGroup-E<gt>B<new>(DATA)
...
Mail::Message::Field::AddrGroup-E<gt>B<defaultTrace>([LEVEL, [LEVEL])
...
Mail::Message::Field::AddrGroup-E<gt>B<log>([LEVEL [,STRINGS]])
...
Mail::Message::Field::AddrGroup-E<gt>B<logPriority>(LEVEL)
