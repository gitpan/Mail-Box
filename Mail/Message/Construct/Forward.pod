...
reply immediately, or you may do that later with C<set> on the header.
 ...
 Subject                           L<forwardSubject()|"Constructing a message">
 To                                <required>                                  
 body                              undef                                       
 include                           C<'INLINE'>                                 
 max_signature                     C<10>                                       
...
the L<forwardSubject()|"Constructing a message"> method is used.
...
Passed to L<Mail::Message::Body::stripSignature(max_lines)|"Constructing a body">.  Only
...
If nothing is specified, the result of the L<forwardPrelude()|"Constructing a message"> method
...
passed to L<Mail::Message::Body::stripSignature(pattern)|"Constructing a body">, unless the
