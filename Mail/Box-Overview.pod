...
their follow-ups.
                       ...
                       <has-a>      L<Mail::Box::Mbox|Mail::Box::Mbox>
  L<Mail::Box::Manager|Mail::Box::Manager> <---------*    (L<Mail::Box::MH|Mail::Box::MH>)
         ^                :         (L<Mail::Box::Maildir|Mail::Box::Maildir>)
         |           (maintains)    (L<Mail::Box::POP3|Mail::Box::POP3>)
         |                :
         |                :
         `---------------------*  L<Mail::Box::Thread::Manager|Mail::Box::Thread::Manager>
                      (<has-a>)
...
long as you stick to the rules).
 ...
 L<Mail::Box::Mbox|Mail::Box::Mbox>  <-----------* L<Mail::Box::Mbox::Message|Mail::Box::Mbox::Message>
        ^             <has-a>            ^
        | <isa>                          | <isa>
        |                                |
    L<Mail::Box|Mail::Box>     ............. L<Mail::Box::Message|Mail::Box::Message>
                                         ^
                                         | <isa>
                                         |
                                   L<Mail::Message|Mail::Message>
                                       ...
                                       <has-a>  
                                      /     \
                           L<Mail::Message|Mail::Message>   L<Mail::Message|Mail::Message> 
                             ::Body            ::Head
