...
The C<examples/open.pl> script contains mainly
 ...
 my $mgr    = L<Mail::Box::Manager|Mail::Box::Manager>->new;
...
L<L<Mail::Message::Construct|Mail::Message::Construct>>.  For a single-part reply, the return
will be
...
=item * L<Mail::Message::buildFromBody()|"Constructing a message">

Start with creating a body, and transform that into a message.

=item * L<Mail::Message::build()|"Constructing a message">

create the whole message at once.

=item * L<Mail::Message::read()|"Constructing a message">
...
mail folders and transmission programs.
 ...
 my $body = L<Mail::Message::Body|Mail::Message::Body>->new
  ( mime_type         => 'text/css'
...
you when executing the next line.
 ...
 my $message = L<Mail::Message|Mail::Message>->buildFromBody
   ( $body
   , From => 'me@example.com'
   , To   => 'you@anywhere.net'
...
multi-part message is produced.
 ...
 my $message = L<Mail::Message|Mail::Message>->build
  ( From       => 'me@example.com'
  , To         => 'you@anywhere.net'
