...
=head1 SYNOPSIS
 ...
 my $sender = L<Mail::Transport::SMTP|Mail::Transport::SMTP>->new(...);
 $sender->send($message);

 # Some extensions implement receiving:
 my $receiver = L<Mail::Transport::POP3|Mail::Transport::POP3>->new(...);
...
You may specify L<new(proxy)|"METHODS">, which specifies the absolute name
...
I<Warning:> Avoid program abuse with an absolute path for $exec.
