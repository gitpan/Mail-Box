...
single line (all Windows versions), the result in file will be L<nrLines()|Mail::Message/"The header">
...
I<Example:> 
 ...
 $msg->head(L<Mail::Message::Head|Mail::Message::Head>->new);  # set
...
way to go is via
 ...
 $message = L<Mail::Message|Mail::Message>->buildFromBody($body);  # or
 $message = L<Mail::Message|Mail::Message>->build($body);          # or
...
I<Example:> 
 ...
 my $new       = L<Mail::Message::Body|Mail::Message::Body>->new(mime_type => 'text/html');
...
I<Example:> of Mail::Message destruct
 ...
 my $msg = L<Mail::Message|Mail::Message>->read;
 $msg->destruct;
 $msg = undef;    # same
...
The general idea about the structure of a message is
 ...
 L<Mail::Message|Mail::Message>
  |  |
  |  `-has-one--L<Mail::Message::Body|Mail::Message::Body>
  |
  `----has-one--L<Mail::Message::Head|Mail::Message::Head>
                  |
                  `-has-many--L<Mail::Message::Field|Mail::Message::Field>
...
(mime type C<message/rfc822>).  These bodies are more complex:
 ...
 L<Mail::Message::Body::Multipart|Mail::Message::Body::Multipart>
  |
  `-has-many--L<Mail::Message::Part|Mail::Message::Part>
               |  |
               |  `-has-one--L<Mail::Message::Body|Mail::Message::Body>
               |
               `----has-one--L<Mail::Message::Head|Mail::Message::Head>
...
The message types are:
 ...
 L<Mail::Box::Mbox::Message|Mail::Box::Mbox::Message>            L<Mail::Box::POP3::Message|Mail::Box::POP3::Message>
 |  L<Mail::Box::Dbx::Message|Mail::Box::Dbx::Message>      L<Mail::Box::IMAP4::Message|Mail::Box::IMAP4::Message>  |
 |  |                                                    |  |
 L<Mail::Box::File::Message|Mail::Box::File::Message>             L<Mail::Box::Net::Message|Mail::Box::Net::Message>
         |                                      |
         |       L<Mail::Box::Maildir::Message|Mail::Box::Maildir::Message>    |
         |       |   L<Mail::Box::MH::Message|Mail::Box::MH::Message>     |
         |       |   |                          |
         |       L<Mail::Box::Dir::Message|Mail::Box::Dir::Message>        |
         |                |                     |
         `------------.   |   .-----------------'
                      |   |   |
                   L<Mail::Box::Message|Mail::Box::Message>    L<Mail::Message::Part|Mail::Message::Part>
                          |                     |
                          |       .-------------'
                          |       |
                      L<Mail::Message|Mail::Message>
                          |
                          |
                    L<Mail::Reporter|Mail::Reporter> (general base class)
...
L<Mail::Box::Message::delete()|Mail::Box::Message/"Flags"> and L<Mail::Box::Message::deleted()|Mail::Box::Message/"Flags">
...
store the message is not released immediately (see L<destruct()|Mail::Message/"Cleanup"> if you
need to).
